...
export default function (): Record<string, Record<string, DefinitionRpc>> {
  ...
  return {
    eth: {
      ...
      sendTransaction: generateDescription('Sends transaction; will block waiting for signer to return the transaction hash', 'BoxFuture<H256>', [
        { name: '_', type: 'TransactionRequest', }
      ]),
